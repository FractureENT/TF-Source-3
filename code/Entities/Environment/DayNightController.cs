...
/// </summary>
[Library( "tf_daynight_controller" )]
[Title( "Time of Day Controller" )]
[Category( "Fog & Sky" )]
[Icon( "timer" )]
[VisGroup( VisGroup.Logic )]
[EditorSprite( "materials/editor/tf_daynight_controller.vmat" )]
[HammerEntity]
public partial class DayNightController : Entity
{
	[Property, Category( "Lighting & Fog" ), ResourceType( "tftime" )]
	public string DawnData { get; set; }
	public TimeStageData Dawn { get; set; }

	[Property, Category( "Lighting & Fog" ), ResourceType( "tftime" )]
	public string DayData { get; set; }
	public TimeStageData Day { get; set; }

	[Property, Category( "Lighting & Fog" ), ResourceType( "tftime" )]
	public string DuskData { get; set; }
	public TimeStageData Dusk { get; set; }

	[Property, Category( "Lighting & Fog" ), ResourceType( "tftime" )]
	public string NightData { get; set; }
	public TimeStageData Night { get; set; }

	[ConVar.Replicated( "tf_debug_daynight" )]
	...
	public override void Spawn()
	{
		...
		Dawn = TimeStageData.Get( DawnData );
		Day = TimeStageData.Get( DayData );
		Dusk = TimeStageData.Get( DuskData );
		Night = TimeStageData.Get( NightData );
	...
	[Net]
	private TimeStageData CurrentFogState { get; set; }

	private TimeStageData UpdateFogState( TimeStage stage )
	{
	...
	private void Tick()
	{
		...
		if ( Game.IsServer )
		{
			...
			if ( DayNightDebug )
			{
				DebugOverlay.ScreenText(
					 ...
					 $"AmbientLight: {Game.SceneWorld.AmbientLightColor}\n" +
		...
		Game.SceneWorld.AmbientLightColor = Color.Lerp( Game.SceneWorld.AmbientLightColor, CurrentFogState.AmbientLightColor, lerpSpeed );
	}
}
